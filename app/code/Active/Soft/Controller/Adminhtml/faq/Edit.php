...
namespace Active\Soft\Controller\Adminhtml\faq;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Active_Soft::Faq')
            ->addBreadcrumb(__('Active Soft'), __('Active Soft'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Active\Soft\Model\Faq');
