...
namespace Active\Module\Controller\Adminhtml\faq;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Active_Module::Faq')
            ->addBreadcrumb(__('Active Module'), __('Active Module'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Active\Module\Model\Faq');
        ...
        $resultPage->addBreadcrumb(__('Active'), __('Active'));
